...
async function createItem (req, res) {
  try {
    ...
    const { toBeTranslated, className, en, de, fr, es, it, price, menuNumber } = req.body
    ...
    const newItem = await Menuitem.create({UserId, toBeTranslated, className, en, de, fr, es, it, price, menuNumber, sortNo});
    res.status(201);
    res.json(newItem);   
  } catch (error) {
    res.status(500);
...
module.exports = {getAll, createUser, deleteUser, createItem, getOne, moveUp, moveDown, deleteItem }