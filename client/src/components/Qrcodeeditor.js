...
import {
  ...
  getQrCodePost,
  getQrCodeGetJPG,
} from "../API_services/QRCode_API";

function Qrcodeeditor(props) {
  const [qrCodeReturn, setQrCodeReturn] = useState("Make your choices");
  ...
  return (
    <div>
      ...
      <button onClick={QRCodeHandler}>QRCode Generator</button>
      {/* <div>{qrCodeReturn}</div> */}
      {/* <div
        
        style={{
          background: qrCodeReturn,
          width: 500,
          height: 500,
        }}
      /> */}

      <img src={qrCodeReturn} className="App-logo" alt="logo" />
      ...
      <div className="colorpicker">
        <label htmlFor="markerleftinnercolor">Inner color left marker: </label>
        <input
          type="color"
      ...
      <div className="colorpicker">
        <label htmlFor="markerleftoutercolor">Outer color left marker: </label>
        <input
          type="color"
      ...
      <div className="templatedropdown">
        <label htmlFor="markerlefttemplate">Template right marker:</label>
