...
function Qrcodeeditor({ userName }) {
  ...
  function createMarkup() {
    return { __html: qrCodeReturn };
  }

  return (
    <div>
      <div className="qrcodedisplaycontainer">
        {qrCodeReturn === "empty" ? (
          <div className="qrcodeplaceholder">
            Your QR Code will appear here.
          </div>
        ) : (
          <div className="qrcode" dangerouslySetInnerHTML={createMarkup()} />
        )}
      </div>
      <form className="menuitemform" onSubmit={QRCodeHandler}>
        <div className="qrcodesettingsblock">
          <button className="qrcodeformbutton" type="submmit">
        ...
        <div className="qrcodesettingsblock">
          ...
          <div className="templatedropdown">
            <label htmlFor="markerbottomtemplate">
              Template bottom marker:
            </label>
